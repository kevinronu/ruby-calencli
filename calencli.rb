...
events = [
  { "id" => (id = id.next),
    "start_date" => "2023-05-13T00:00:00-05:00",
    "title" => "Ruby Basics 1",
    "end_date" => "",
    ...
    "calendar" => "web-dev" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-13T09:00:00-05:00",
    "title" => "English Course",
    "end_date" => "2023-05-13T10:30:00-05:00",
    "notes" => "English notes",
    "guests" => ["Stephanie"],
    "calendar" => "english" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-14T00:00:00-05:00",
    "title" => "Ruby Basics 2",
    "end_date" => "",
    ...
    "calendar" => "web-dev" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-14T12:00:00-05:00",
    "title" => "Soft Skills - Mindsets",
    "end_date" => "2023-05-14T13:30:00-05:00",
  ...
  { "id" => (id = id.next),
    ...
    "calendar" => "web-dev" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-15T09:00:00-05:00",
    "title" => "English Course",
    "end_date" => "2023-05-15T10:30:00-05:00",
    "notes" => "English notes",
    "guests" => ["Stephanie"],
    "calendar" => "english" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-16T09:00:00-05:00",
    "title" => "Summary Workshop",
    "end_date" => "2023-05-16T13:30:00-05:00",
    "notes" => "A lot of notes",
    "guests" => ["Paulo", "Andre", "Diego"],
    "calendar" => "web-dev" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-16T00:00:00-05:00",
    ...
    "calendar" => "web-dev" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-17T09:00:00-05:00",
    "title" => "Extended Project",
    "end_date" => "",
    "notes" => "",
    "guests" => [],
  ...
  { "id" => (id = id.next),
    "start_date" => "2023-05-17T09:00:00-05:00",
    "title" => "English Course",
    "end_date" => "2023-05-17T10:30:00-05:00",
    "notes" => "English notes",
    "guests" => ["Stephanie"],
    "calendar" => "english" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-18T10:00:00-05:00",
    "title" => "Breakfast with my family",
    "end_date" => "2023-05-18T11:00:00-05:00",
    "notes" => "",
    "guests" => [],
    "calendar" => "default" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-18T15:00:00-05:00",
    "title" => "Study",
    "end_date" => "2023-05-18T20:00:00-05:00",
    "notes" => "",
    "guests" => [],
    "calendar" => "default" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-23T00:00:00-05:00",
    "title" => "Extended Project",
    "end_date" => "",
    "notes" => "",
    "guests" => [],
    "calendar" => "web-dev" },
  { "id" => (id = id.next),
    "start_date" => "2023-05-24T09:00:00-05:00",
    "title" => "Extended Project",
    "end_date" => "",
    "notes" => "",
    "guests" => [],
